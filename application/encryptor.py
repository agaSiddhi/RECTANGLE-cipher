...
def encrypt(state,key):
    ...
    cipher = hex(int(finalstring,2))[2:]
    print("hexform of cipher is:",cipher)
    return cipher
...
# encryption("534944444849") #SIDDHI 5349444448490000
