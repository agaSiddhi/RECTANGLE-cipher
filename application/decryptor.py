...
def decrypt(cipher,ke):
    ...
    plaintext_hex = hex(int(finalstring,2))[2:]
    print("hexform of plaintext is:",plaintext_hex)
...
# print(decryption("e36be065fdfb31a7")) #5349444448490000
